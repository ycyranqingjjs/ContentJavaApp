...
import com.ycy.common.base.delegate.IActivity;
import com.ycy.common.integration.cache.Cache;
import com.ycy.common.integration.cache.CacheType;
import com.ycy.common.integration.lifecycle.ActivityLifecycleable;
 ...
 * 继承于这个特定的 {@link Activity},然后再按照 {@link CBaseActivity} 的格式,将代码复制过去,记住一定要实现{@link IActivity}
 *
 ...
 * ================================================
 */
public abstract class CBaseActivity<P extends IPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
