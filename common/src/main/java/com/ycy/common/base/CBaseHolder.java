...
import com.ycy.common.utils.ThirdViewUtil;
import com.ycy.framework.widget.autolayout.utils.AutoUtils;
 ...
 * ================================================
 */
public abstract class CBaseHolder<T> extends RecyclerView.ViewHolder implements View.OnClickListener {
    protected OnViewClickListener mOnViewClickListener = null;
    protected final String TAG = this.getClass().getSimpleName();

    public CBaseHolder(View itemView) {
        super(itemView);
