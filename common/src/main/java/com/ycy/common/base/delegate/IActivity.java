...
public interface IActivity {
     ...
     * 如果返回false,那意味着这个Activity不需要绑定Fragment,那你再在这个Activity中绑定继承于 {@link CBaseFragment} 的Fragment将不起任何作用
     *
     * @return
     */
    boolean useFragment();
    ...
    /**
     * 初始化 View,如果getLayoutId返回0,框架则不会调用{@link Activity#setContentView(int)}
     *
     * @param savedInstanceState
     * @return
     */
